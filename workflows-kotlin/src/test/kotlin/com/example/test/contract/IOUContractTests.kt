...
//            transaction {
//                output(IOUContract.ID, TradeState(iouValue, miniCorp.party, megaCorp.party))
//                fails()
...
//        ledgerServices.ledger {
//            transaction {
//                input(IOUContract.ID, TradeState(iouValue, miniCorp.party, megaCorp.party))
//                output(IOUContract.ID, TradeState(iouValue, miniCorp.party, megaCorp.party))
//                command(listOf(megaCorp.publicKey, miniCorp.publicKey), IOUContract.Commands.Create())
...
//        ledgerServices.ledger {
//            transaction {
//                output(IOUContract.ID, TradeState(iouValue, megaCorp.party, megaCorp.party))
//                command(listOf(megaCorp.publicKey, miniCorp.publicKey), IOUContract.Commands.Create())
...
//        ledgerServices.ledger {
//            transaction {
//                output(IOUContract.ID, TradeState(-1, miniCorp.party, megaCorp.party))
//                command(listOf(megaCorp.publicKey, miniCorp.publicKey), IOUContract.Commands.Create())
